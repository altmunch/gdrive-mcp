...
// Render.com startup script for REST API server
const fs = require('fs');
const path = require('path');

console.log('Setting up credentials for Render.com REST API server...');
...
const credsDir = process.env.GDRIVE_CREDS_DIR || '/opt/render/project/src';
...
console.log('✓ OAuth keys file created');

console.log('🚀 Starting REST API server...');

// Start the REST API server
require('./dist/rest-api-server.js');